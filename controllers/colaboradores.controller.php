            ...
            foreach($data as $registro){
                ...
                echo"
                    ...
                    if ($registro['cv'] == ''){
                        ...
                        echo " <a href='../views/pdf/documentos/{$registro['cv']}' data-lightbox='{$registro['idcolaborador']}' data-title='{$datosColaborador}' class='btn btn-sm btn-warning'><i class='bi bi-eye-fill'></i></a>";
                    }
